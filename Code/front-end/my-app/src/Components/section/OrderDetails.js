...
render(){
    ...
    <Container className="orderContainer">
       ...
       <Col md="7" className="summaryDiv"> 
               ...
               <p><b>Order Date</b>: October 08,2020</p>
               <p><b>Order Number</b>: W09B2345BVC5</p>
               <p><b>Total</b>: $26.34</p>
               </div>
        <div className="orderSummary2">
            <p><b>Ship To</b></p>
            <p>Akhitha Tumula, 1115N college drive, maryville, Missouri</p>
        </div>
       ...
       <Col md="4" className="summaryDiv2">
        ...
        <div className="p-2">
      <div className="orderSummary"><p>SubTotal:</p><p>$21</p></div>
      <div className="orderSummary"><p>Discounts/Coupon</p><p>$0</p></div>
      <div className="orderSummary"><p>Shipping and Handling</p><p>$2</p></div>
      <div className="orderSummary"><p>tax</p><p>$3</p></div>
      <div className="orderSummary"><p>Total:</p><p>$26</p></div>
      </div>
      ...
      <div className="orderSummary"><p>Akhitha Tumula<br />1121 N College Dr<br />Horizons West Apartment 2<br /></p></div>
      <div className="p-1"><p>Contact Information</p></div>
      <div className="orderSummary"><p>Akhitha Tumula<br />akhitha.tumula@gmail.com<br />9876543456<br /></p></div>
