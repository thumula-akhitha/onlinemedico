...
class LoginForm extends React.Component {
  ...
  login(e){
    ...
    axios.post('http://127.0.0.1:3333/onlinemedico/user/login', request)
      .then(res => {
          ...
          <div className="col-11">
            <div className="loginForm">
              <form onSubmit={this.login}>
                ...
                <Link className="links" to="/sign"><u>Signup</u></Link>
                </p>
                <Link className="forgot-link" to="/forgot"><u>Forgot Password?</u></Link>     
